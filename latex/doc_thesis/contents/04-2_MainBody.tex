...
注：文中符号说明——VDD (positive supply，电源正极)、VSS (negative supply/ground，电源负极)、VCM (common-mode voltage，共模电压)、VGS (gate–source voltage，栅源电压)。
...
电路的等效开环增益提升，其最主要的表现是整体SC放大器的闭环
