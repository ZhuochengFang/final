...
针对这些问题，本文提出了一种基于 低压浮动反相放大器 (Low-Voltage Floating Inverter Amplifier, LVFIA) 和 相关电平移位 (Correlated Level Shifting, CLS) 技术的创新架构设计方法，
...
design method based on Low-Voltage Floating Inverter Amplifier (LVFIA) and 
...
\noindent{\bfseries Keywords: }Dynamic Amplifier；Correlated Level Shifting；Low-Voltage Analog Integrated Circuit Design
